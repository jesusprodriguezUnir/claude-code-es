...
export const TYPE_CONFIG: Record<string, { icon: string; label: string; singular: string; color: string; flag: string }> = {
  ...
  agents:   { icon: 'agents',   label: 'Agentes',       singular: 'agente',       color: '#3b82f6', flag: '--agent' },
  commands: { icon: 'commands', label: 'Comandos',      singular: 'comando',      color: '#10b981', flag: '--command' },
  settings: { icon: 'settings', label: 'Configuraci\u00f3n', singular: 'configuraci\u00f3n', color: '#8b5cf6', flag: '--setting' },
