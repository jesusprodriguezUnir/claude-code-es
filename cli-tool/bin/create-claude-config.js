...
const title = 'Claude Code ES';
const subtitle = 'Tu punto de partida para proyectos con Claude Code';
...
function showBanner() {
  ...
  console.log(
    chalk.hex('#D97706')('🚀 Configura Claude Code para tu proyecto 🚀') +
    chalk.gray(`\n                             v${pkg.version}\n\n`) +
    chalk.blue('🌐 Componentes: ') + chalk.underline('https://claudecodees.vercel.app') + '\n' +
    chalk.blue('📦 npm: ') + chalk.underline('https://www.npmjs.com/package/claude-code-es') + '\n'
  );
}
